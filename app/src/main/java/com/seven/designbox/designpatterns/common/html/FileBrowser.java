...
/***
 * @author John Lombard
 *         This class belongs to Jonh Lombard from anddev.org, its a very basic class  but its a
 *         good starting point for a filebrowser
    ...
    private void browseTo(final File aDirectory) {
        if (aDirectory.isDirectory()) {
            ...
            Intent resultIntent = new Intent(
                    Intent.ACTION_VIEW, Uri.parse("file://"
